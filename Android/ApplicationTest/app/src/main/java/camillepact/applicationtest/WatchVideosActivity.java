...
public class WatchVideosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i = pm.getLaunchIntentForPackage("com.google.android.gm");
                startActivity(i);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_watch_videos, menu);
        return true;
    }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                "WatchVideos Page", // TODO: Define a title for the content shown.
                // TODO: If you have web page content that matches this app activity's content,
                // make sure this auto-generated web page URL is correct.
                // Otherwise, set the URL to null.
                Uri.parse("http://host/path"),
                // TODO: Make sure this auto-generated app deep link URI is correct.
                Uri.parse("android-app://camillepact.applicationtest/http/host/path")
        );
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(getArguments().getInt(ARG_SECTION_NUMBER) == 3) {
                VideoView videoView = (VideoView) rootView.findViewById(R.id.videoView2);
                Context context = getContext();
                String uriPath = "android.resource://" + context.getPackageName()+ "/" + R.raw.video3;
                videoView.setVideoURI(Uri.parse(uriPath));
                videoView.start();
